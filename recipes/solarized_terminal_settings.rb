#taken from https://github.com/newcontext/pivotal_workstation/blob/master/recipes/solarized_terminal_settings.rb
git "#{Chef::Config[:file_cache_path]}/solarized_terminal" do
  repository "git://github.com/mohangk/osx-lion-terminal.app-colors-solarized.git"
